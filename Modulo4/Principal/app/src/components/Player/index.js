...
const Player = ({
    ...
    prev, playing, position,
    duration, handlePosition, setPosition,
    positionShown, progress
}) => (
        <Container>
            {!!player.currentSong && (
                <Sound
            ...
            <Progress>
                <Controls>
                    ...
                    <button onClick={prev}><img src={BackwardIcon} alt="Backward" /></button>
